    ...
    return (
        <>
           {deposit && <div className='mt-5 md:mt-0'>
                <div className='rounded-md bg-[#0D0D0D] py-3 mb-3 w-full tablet:w-4/6 m-auto border-[1px] border-[#6D7D93] iphonesm:w-5/6 iphonesm:m-auto lg:relative lg:top-48 md:relative md:top-48'>
