...
const Statistics = () => {
  ...
  return (
    <div className={`flex w-5/6 md:w-2/6 tablet:w-4/6 lg:w-2/6 md:gap-10 iphonesm:gap-7 lg:gap-32 gap-28 m-auto mt-3 ${navbar ? 'iphonesm:w-4/6 iphonesm:relative iphonesm:left-5' : ''}`}>
